...
public class ConverterView extends javax.swing.JFrame implements Runnable
{
    ...
    private void initializeUiForDevice()
    {
        ...
        {                      
            ...
            trackModel.clear();
            trackDirectoryList.addFilesToListModel(trackModel);
            
            locationModel.clear();
            locationDirectoryList.addFilesToListModel(locationModel);
            
            routeModel.clear();
            routeDirectoryList.addFilesToListModel(routeModel);

            newFileModel.clear();
            newFileDirectoryList.addFilesToListModel(newFileModel);
