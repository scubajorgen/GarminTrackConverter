...
public class ConverterAbout extends javax.swing.JDialog
{
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(ConverterAbout.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                ConverterAbout dialog = new ConverterAbout(new javax.swing.JFrame(), true);
